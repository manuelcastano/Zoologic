	...
	public void showMenu(){
		...
		System.out.println("10. Salir");
			...
			switch(option){
				...
				case(3):
					System.out.println("");
					System.out.println("El primer dragon mide "+zooCali.getDragonZone().getDra1().getHeight()+" metros y pesa "+zooCali.getDragonZone().getDra1().getWeight()+" kilos");
					System.out.println("El segundo dragon mide "+zooCali.getDragonZone().getDra2().getHeight()+" metros y pesa "+zooCali.getDragonZone().getDra2().getWeight()+" kilos");
					System.out.println("");
					break;
				case(4):
					System.out.println("");	
					System.out.println("La fuente de calor esta en "+zooCali.getKangarooZone().getHeatSource()+" grados");
					System.out.println("la zona tiene un "+zooCali.getKangarooZone().getHumidity()+" % de humedad");
					System.out.println("La zona esta en "+zooCali.getKangarooZone().getTemperature()+" grados");
					System.out.println("La filtracion es de " +zooCali.getKangarooZone().getFiltration());
					System.out.println("La zona necesita " +zooCali.getKangarooZone().getWaterLiters()+" litros de agua");
					System.out.println("");
					break;
				case(5):
					System.out.println("");
					System.out.println("El ambiente 1 tiene de area "+zooCali.getKangarooZone().getEnv1().environmentArea()+" y necesita de comida "+zooCali.getKangarooZone().getEnv1().calculateFood()+" kg de comida");
					System.out.println("El ambiente 2 tiene de area "+zooCali.getKangarooZone().getEnv2().environmentArea()+" y necesita de comida "+zooCali.getKangarooZone().getEnv2().calculateFood()+" kg de comida");
					System.out.println("El ambiente 3 tiene de area "+zooCali.getKangarooZone().getEnv3().environmentArea()+" y necesita de comida "+zooCali.getKangarooZone().getEnv3().calculateFood()+" kg de comida");
					System.out.println("");				    
				break;
				case(6):
				...
				break;
				case(8):
				    int kangaroo = reader.nextInt();
					int ambient = reader.nextInt();
				    zooCali.changeEnvironment(kangaroo, ambient);
				break;
				case(9):
				    eliminateKangaroo();
				break;
